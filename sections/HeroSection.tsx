    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p>I'm a DevOps Engineer based in Kerala, India.</p>
          <p>
            A developer turned DevOps Engineer with a passion for automating everything.
          </p>
          Experience with Java, Python, Linux, Bash, MySQL, PostgreSQL, AWS, Azure, Jenkins, Docker, Kubernetes, Ansible, SaltStack Terraform and more.
        </div>
